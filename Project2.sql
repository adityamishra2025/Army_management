...
WHERE p.district = 'Lucknow' AND p.ptill > CURDATE();
...
FROM soldier s
JOIN operation o ON s.operationcode = o.operationcode
WHERE o.oname = 'Operation Sahyog';
